  ...
  return (
    <>
      <motion.div
        ...
        className="fixed top-4 left-1/2 -translate-x-1/2 z-50 h-14 bg-white dark:bg-[#151515] rounded-full shadow-[0_8px_30px_rgba(0,0,0,0.08)] dark:shadow-[0_8px_30px_rgba(0,0,0,0.3)] flex items-center gap-6 px-4"
      >
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="fixed top-20 left-1/2 -translate-x-1/2 z-40 w-[240px] bg-white dark:bg-[#151515] rounded-2xl shadow-[0_8px_30px_rgba(0,0,0,0.08)] dark:shadow-[0_8px_30px_rgba(0,0,0,0.3)] p-2 md:hidden"
          >
